...
# Run Baseline
python model_scripts/Autoregressive_modeling/qwen.py 0 "Baseline"
...
python model_scripts/Autoregressive_modeling/qwen.py 0 "Basic"
python get_runtime_HF.py
...
python model_scripts/Autoregressive_modeling/qwen.py 0 "1"
python get_runtime_HF.py
...
python model_scripts/Autoregressive_modeling/qwen.py 0 "2"
python get_runtime_HF.py
...
python model_scripts/Autoregressive_modeling/qwen.py 1 "2"
