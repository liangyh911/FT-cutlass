...
def eager_attention_forward(
    ...
    **kwargs: Unpack[TransformersKwargs],
    ...
    # value ...
    # print("attn_weights after softmax: ")
    # print(attn_weights[0][0])
...
class LlamaDecoderLayer(GradientCheckpointingLayer):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        # print(f"ATTN time: {elapsed_time}")
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        for i, decoder_layer in enumerate(self.layers[: self.config.num_hidden_layers]):
            ...
            # job_id = os.getenv('SLURM_JOB_ID')
            # if_injection = True
            # if(i == 0 and if_injection):
            #     with open(f"/home/yuhangl/control_{job_id}/FI.txt", "w") as file:
            #         file.truncate(0)
            #         file.write('t')
            # else:
            #     with open("/home/yuhangl/control_{job_id}/FI.txt", "w") as file:
            #         file.truncate(0)
            #         file.write('f')
            # print("hidden states:")
