...
struct AttentionKernel {
  ...
  static void CUTLASS_DEVICE attention_kernel(Params& p) {
    ...
    // if(threadIdx.x == 0) printf("attention_kernel\n");
    ...
    for (int32_t iter_key_start = 0; iter_key_start < p.num_keys;
      ...
      //   int tiled_m = (tb_tile_offset.m() * MM0::Mma::WarpCount::kM) + (my_warp_id % MM0::Mma::WarpCount::kM);
      //   int tile_n = (tb_tile_offset.n() * MM0::Mma::WarpCount::kN) + (my_warp_id / MM0::Mma::WarpCount::kM);
      //   printf("smid: %d, iteratorC_tile_offset(%d, %d)\n", smid, tiled_m, tile_n);
      // }
