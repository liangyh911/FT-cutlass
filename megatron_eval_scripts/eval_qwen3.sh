...
# Run Baseline
bash ./megatron_run_model_scripts/run_qwen3.sh 0 "Baseline"
...
bash ./megatron_run_model_scripts/run_qwen3.sh 0 "Basic"
python get_runtime_Megatron.py
...
bash ./megatron_run_model_scripts/run_qwen3.sh 0 "1"
python get_runtime_Megatron.py
...
bash ./megatron_run_model_scripts/run_qwen3.sh 0 "2"
python get_runtime_Megatron.py
