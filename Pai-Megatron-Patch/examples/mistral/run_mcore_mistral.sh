...
run_cmd="torchrun $DISTRIBUTED_ARGS /workspace/Pai-Megatron-Patch/examples/mistral/pretrain_mcore_mistral.py
 ${megatron_options} ${dataset_option} ${pr_options} ${load_options} ${te_options} ${activation_checkpoint_options} \
 ${do_options} ${sp_options} ${gqa_options} ${offload_option} ${sft_option} ${moe_options} ${tie_option} ${vp_options} ${packing_options}"
