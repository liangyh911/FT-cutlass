...
# MEGATRON_PATH=${MEGATRON_PATCH_PATH}/Megatron-LM-250624
...
run_cmd="torchrun $DISTRIBUTED_ARGS /workspace/Pai-Megatron-Patch/examples/llama2/finetune_megatron_llama_withGA.py
 ${megatron_options} ${pr_options} ${load_options} ${te_options} ${activation_checkpoint_options} ${do_options} ${flash_options} ${sp_options} ${gqa_options} ${moe_options} ${attn_backend_option}"
