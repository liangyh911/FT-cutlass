...
def get_gpt_layer_local_spec(
    ...
    """Use this spec to use local Megatron-Core modules (No Transformer Engine).
    
    Args:
        num_experts (int, optional): Number of experts. Defaults to None.
        moe_grouped_gemm (bool, optional): To use Grouped GEMM. Defaults to False.
        qk_layernorm (bool, optional): To use layernorm for queries/keys. Defaults to False.
        multi_latent_attention (bool, optional): Whether to use MLA. Defaults to False.

    Returns:
        ModuleSpec: Module specification with Local modules
    """
    ...
    mlp_moe = _get_mlp_module_spec(
        use_te=False, num_experts=num_experts, moe_grouped_gemm=moe_grouped_gemm, fp8=None
    )
    mlp_dense = _get_mlp_module_spec(
        use_te=False, num_experts=None, moe_grouped_gemm=moe_grouped_gemm, fp8=None
    )
